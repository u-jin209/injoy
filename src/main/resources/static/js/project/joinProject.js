                    ...
                    result.forEach(function (item) {
                        $(document).ready(function () {
                            ...
                            $('#searchDivMain').append(
                                ...
                                " <div class='row' style='height:100px ;text-align: left; display: block; MARGIN-RIGHT: 0;' id=" + item.projectId + ">" +
                                ...
                                "<button class='btn btn-green' style='width: 65px;' id='enterBtnCode" + item.projectId + "' name='" + item.projectId + "' onclick='enterProject(this,2)'> 참가 </button>" +
            ...
            success: function (item) {
                ...
                if (item.length != 0) {
                    ...
                    $('#searchCodeDivMain').append(
                        ...
                        "<div class ='row' style='justify-content: space-around'>" +
                        "<button class='btn btn-green' style='width: 65px;' id='enterBtnCode' name='" + item.projectId + "' onclick='enterProject(this,2)'> 참가 </button>" +
