                    ...
                    $(document).ready(function () {
                        $('#projectListBody').append(
                            "<div class='col-md-3 '  style='float: left'>"+
                                "<div class='project' style='padding: 10px 20px 10px 20px'>"+
                                    "<div class='row' >"+
                                        "<div class='col' style='text-align: left'>"+
                                            "<button  class='btn' style='|${p.getBookMarkId() == 0  ? 'display:unset ;': 'display :none ;'}|' onclick='|bookMark(${p.getProjectId()}, ${p.getUserId()})|'>"+
                                            ...
                                            "</svg></button>"+
                                        "<button id='starFill"+item.projectId+"' class='btn' style='|${ p.getBookMarkId() == 0 ? 'display : none ;': 'display : unset ;'}|' onclick='|bookMark(${p.getProjectId()}, ${p.getUserId()})|'>"+
                                ...
                                "<div class='col' style='text-align: end'>"+
                                    "<button class='btn ' type='button' id=  data-toggle='modal' data-target='#memberModal' onclick='memberList(this)'>" +
                        ...
                        "<div class='row' id= >"+
                            "<div class='col' style='float: left;'>" +
                                "<div class='subTitle' >"+item.organName+"</div>"+
                            "</div></div>"+


                       " <div class='row' style='display: block; MARGIN-RIGHT: 0;' onclick='goProject(this)'>"+
                                ...
                                "<div class='modal-content'>"+
                                    "<div class='modal-header'>"+
                                        ...
                                        "<div class='col-md-1'>"+
                                            ...
                                            "</button></div></div>"+
                                    "<div class='modal-body scrollDiv' id='modal-body'  style='height: 500px;overflow-y: scroll  '>"+
